...
(function () {
  ...
  function render(report) {
    ...
    if (wa) {
      ...
      wa.href = "https://wa.me/27635594183?text=" + encodeURIComponent(msg);
    }
    ...
    return "<!DOCTYPE html><html lang=\"en\"><head><meta charset=\"utf-8\">" +
      ...
      "<main class=\"page\">" +
        ...
        "<section class=\"cta\"><h3>Want us to fix this for you?</h3>" +
          ...
          "<p class=\"contact\"><strong>Santi Universe</strong> &nbsp;·&nbsp; santi.co.za &nbsp;·&nbsp; santi@santi.co.za &nbsp;·&nbsp; +27 63 559 4183</p>" +
